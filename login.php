...
if (isset($_POST['submit'])) {
	...
	if ($query) {
		echo "<script>alert('You are successfully registered please log in now.');</script>";
	} else {
		echo "<script>alert('Not registered something went worng please try again');</script>";
	}
}
// Code for User login
			...
			<div class="sign-in-page inner-bottom-sm">
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 create-new-account">
						...
						<p class="text title-tag-line">Create your own Bookly account.</p>
						...
						<div class="checkbox">
							...
							<label class="checkbox">Keep a record of all your purchases made at our bookly store</label>

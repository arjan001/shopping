...
<head>
	...
	<title>Bookly Portal | Forgot Password</title>
					...
					<div class="col-md-6 col-sm-6 sign-in">
						...
						<form class="register-form outer-top-xs" name="register" method="post">
							...
							<div class="form-group">
								...
								<input type="text" name="contact" class="form-control unicase-form-control text-input" id="contact" required placeholder="Your contact Number">
							</div>
							<div class="form-group">
								<label class="info-title" for="password">Password. <span>*</span></label>
								<input type="password" class="form-control unicase-form-control text-input" id="password" name="password" required placeholder="Enter your password new password">
							</div>

							<div class="form-group">
								<label class="info-title" for="confirmpassword">Confirm Password. <span>*</span></label>
								<input type="password" class="form-control unicase-form-control text-input" id="confirmpassword" name="confirmpassword" required placeholder="Retype your new  password">
							</div>
